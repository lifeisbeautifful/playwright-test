...
export class SmartTablePage {
  ...
  constructor(page: Page) {
    ...
    this.tableRowOption1 = (columnText: string) =>
      this.page.getByRole('table').locator('tr').filter({ hasText: columnText });
    this.rowDeleteBtn = (columnText: string) =>
      this.tableRowOption1(columnText).locator('.nb-trash');
    ...
    this.tableRowOption3 = (columnText: string, columnPosition: number) =>
      this.page
        .getByRole('row', { name: columnText })
        .filter({ has: page.locator('td').nth(columnPosition).getByText(columnText) });
    this.rowEditBtn2 = (columnText: string, columnPosition: number) =>
      this.tableRowOption3(columnText, columnPosition).locator('.nb-edit');
    this.editColumn = (placeholder: string) =>
      this.page.locator('input-editor').getByPlaceholder(placeholder);
    this.checkMark = this.page.locator('.nb-checkmark');
    this.paginationNav = this.page.locator('.ng2-smart-pagination-nav');
    this.columnFilterInput = (placeholder: string) =>
      this.page.locator('input-filter').getByPlaceholder(placeholder);
  }
  ...
  async editColumnTextAvoidDuplication(
    oldValue: string,
